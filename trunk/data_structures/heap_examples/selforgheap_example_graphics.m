...
%graphic example for self-organizing heaps;
...
% pauses
pn=2;px=4; 
figure('Resize','off','NumberTitle','off','Name','selforgheap_example_graphics');
axis('manual');
axis('off');
hold on;
x=0;y=1;dx=0.05;
...
text(0,0.95,'We can bulid self-organizing heap using function lh=selforgheap\_arrtoheap(ar)');
text(0.5,0.9,'ar - our array');
pause(pn);
...
hold on;
axis('off');
text(-0.1,1,'and decrease priority of this element using function lh=selforgheap\_diffprior(lh,p)');
