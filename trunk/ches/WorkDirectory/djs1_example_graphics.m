...
text(0,0.9,'We can unite two subsets using function djs=djs\_join(djs,name1,name2)');
text(0,0.85,'djs - our set, name1 - name of first subset, name - name of second subset');
text(0,0.8,'in this example name1=11, name2=4');
pause(pn);
text(0,0.75,'RESULT:');
b(1,4)=1;
treeplot(b);
...
text(0,0.75,'RESULT:','Color',[0.8 0.8 0.8]);
text(0,0.8,'in this example name1=11, name2=4','Color',[0.8 0.8 0.8]);
text(-0.1,0.95,'We can find name of subset that contains element using function [n,djs]=djs\_join(djs,elem)');
