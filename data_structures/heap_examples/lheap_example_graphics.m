...
function lheap_example_graphics()
...
text(0,0.95,'We can bulid left hand heap using function lh=lheap\_arrtoheap(ar)');
text(0.5,0.9,'ar - our array');
pause(pn);

%Transform array to heap
lh=lheap_arrtoheap(ar);
